...
- Solution URL: (https://github.com/H-Keshk/Social-links-Profile)
- Live Site URL: (https://h-keshk.github.io/Social-links-Profile/)
...
- Flexbox
- Media Queries
- Focus and hover techniques
- Mobile-first workflow


### Continued development

- The media queries and how to make my design more smooth, yet I don't feel comfrtable with responsive idea.
